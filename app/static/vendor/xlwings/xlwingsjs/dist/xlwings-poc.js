...
/* harmony export */   "processResult": function() { return /* binding */ processResult; },
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 2:
                    _g.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, Excel.run(function (context) { return __awaiter(_this, void 0, void 0, function () {
                            var workbook, worksheets, sheets, configSheet, config, configRange, configValues, includeArray, excludeArray, property, payload, activeSheet, selection, names, namedItems, names2, sheetsLoader, namesSheetScope, namesSheetsScope2, _loop_1, _i, sheetsLoader_1, item;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        workbook = context.workbook;
                                    ...
                                    case 10:
                                        ...
                                        _loop_1 = function (item) {
                                            var sheet, values, categories_1, tablesArray, tables, tablesLoader, _b, _c, table, _d, tablesLoader_1, table, picturesArray, shapes, _e, _f, shape;
                                            return __generator(this, function (_g) {
                                                switch (_g.label) {
                                                    case 0:
                                                        sheet = item["sheet"];
                                                    ...
                                                    case 1:
                                                        _g.sent();
                                                        tablesLoader = [];
                                                        for (_b = 0, _c = sheet.tables.items; _b < _c.length; _b++) {
                                                            table = _c[_b];
                                                            tablesLoader.push({
                                                                name: table.name,
                                                    ...
                                                    case 2:
                                                        _g.sent();
                                                        for (_d = 0, tablesLoader_1 = tablesLoader; _d < tablesLoader_1.length; _d++) {
                                                            table = tablesLoader_1[_d];
                                                            tablesArray.push({
                                                                name: table.name,
                                                    ...
                                                    case 4:
                                                        _g.sent();
                                                        for (_e = 0, _f = sheet.shapes.items; _e < _f.length; _e++) {
                                                            shape = _f[_e];
                                    ...
                                    case 13:
                                        _i++;
                                        return [3 /*break*/, 11];
                                    case 14: return [2 /*return*/, JSON.stringify(payload)];
                                }
                            });
                        }); })];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, Excel.run(function (context) { return __awaiter(_this, void 0, void 0, function () {
                            var rawData, forceSync, _loop_2, _i, _a, action;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        rawData = JSON.parse(data);
                                        if (!(rawData !== null)) return [3 /*break*/, 4];
                                        forceSync = ["sheet"];
...
/******/ })()
;
//# sourceMappingURL=xlwings-poc.js.map